# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 15:45:29 2024
...
class Worker(QRunnable):
    ...
    def __init__(self,VIS,NIR,VISNIR,writeToExcel,number,
                 radioButton_1, radioButton_2, radioButton_3, radioButton_5):
        super().__init__()
...
class MatplotlibWidget(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        #self.lineEdit_9.returnPressed.connect(self.get_parameters)
    ...
    def Treading(self):
        ...
        self.thread = QThread()
        self.runner = Worker(self.VIS, self.NIR, self.VISNIR, self.writeToExcel, self.spinBox_5.value(),
                             self.radioButton_1, self.radioButton_2, self.radioButton_3, self.radioButton_5)
